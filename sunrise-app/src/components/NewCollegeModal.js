      ...
      <div className="relative bg-white border-4 border-black w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div className="sticky top-0 bg-pink-400 border-b-4 border-black p-6 z-10">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => setIsOpen(false)}
              className="px-4 py-2 font-bold text-2xl border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all"
            >
              ✕
            </button>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {selectedCollege && availableDeadlines.length === 0 && (
            <div className="bg-red-400 border-4 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t-4 border-black">
            <button
              ...
              className="flex-1 bg-amber-400 border-4 border-black px-6 py-4 font-black text-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all disabled:opacity-50 disabled:cursor-not-allowed uppercase"
            >
